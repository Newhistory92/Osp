...
CREATE TABLE Prestador (
    ...
    tipo NVARCHAR(1000) CONSTRAINT Prestador_tipo_df DEFAULT 'FIDELIZADO',
    address VARCHAR(200),
    coordinatesLat INT,
    coordinatesLon INT,
...
-- AddForeignKey Publicacion_autorId_fkey
ALTER TABLE Publicacion ADD CONSTRAINT Publicacion_autorId_fkey FOREIGN KEY (autorId) REFERENCES Operador(id) ON DELETE NO ACTION ON UPDATE CASCADE;

-- AddForeignKey Opinion_autorId_fkey
ALTER TABLE Opinion ADD CONSTRAINT Opinion_autorId_fkey FOREIGN KEY (autorId) REFERENCES Afiliado(id) ON DELETE NO ACTION ON UPDATE CASCADE;

-- AddForeignKey Denuncia_autorId_fkey
ALTER TABLE Denuncia ADD CONSTRAINT Denuncia_autorId_fkey FOREIGN KEY (autorId) REFERENCES Afiliado(id) ON DELETE NO ACTION ON UPDATE CASCADE;

-- AddForeignKey Denuncia_prestadorId_fkey
ALTER TABLE Denuncia ADD CONSTRAINT Denuncia_prestadorId_fkey FOREIGN KEY (prestadorId) REFERENCES Prestador(id) ON DELETE NO ACTION ON UPDATE CASCADE;

-- AddForeignKey Notificacion_autorId_fkey
ALTER TABLE Notificacion ADD CONSTRAINT Notificacion_autorId_fkey FOREIGN KEY (autorId) REFERENCES Operador(id) ON DELETE NO ACTION ON UPDATE CASCADE;

-- AddForeignKey Notificacion_receptorId_fkey
ALTER TABLE Notificacion ADD CONSTRAINT Notificacion_receptorId_fkey FOREIGN KEY (receptorId) REFERENCES Afiliado(id) ON DELETE NO ACTION ON UPDATE CASCADE;

-- AddForeignKey Notificacion_receptorPrestadorId_fkey
ALTER TABLE Notificacion ADD CONSTRAINT Notificacion_receptorPrestadorId_fkey FOREIGN KEY (receptorPrestadorId) REFERENCES Prestador(id) ON DELETE SET NULL ON UPDATE CASCADE;
