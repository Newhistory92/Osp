BEGIN TRY
    ...
    CREATE TABLE [dbo].[Afiliado] (
        ...
        [role] NVARCHAR(1000) DEFAULT 'USER',
    ...
    CREATE TABLE [dbo].[Prestador] (
        ...
        [role] NVARCHAR(1000) DEFAULT 'PROVIDER',
        [tipo] NVARCHAR(1000) DEFAULT 'FIDELIZADO',
        [address] VARCHAR(200),
        [coordinatesLat] INT,
        [coordinatesLon] INT,
        [createdAt] DATETIME2 NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ...
    CREATE TABLE [dbo].[Operador] (
        ...
        [role] NVARCHAR(1000) DEFAULT 'EMPLOYEE',
        [createdAt] DATETIME2 NOT NULL DEFAULT CURRENT_TIMESTAMP,
        [updatedAt] DATETIME2 NOT NULL,
    ...
    CREATE TABLE [dbo].[Denuncia] (
        ...
        [status] NVARCHAR(1000) DEFAULT 'Nuevo',
        [createdAt] DATETIME2 NOT NULL DEFAULT CURRENT_TIMESTAMP,
        [updatedAt] DATETIME2 NOT NULL,
    ...
    CREATE TABLE [dbo].[Notificacion] (
        ...
        [contenido] TEXT NOT NULL,
        [autorId] NVARCHAR(1000) NOT NULL,
        [receptorId] NVARCHAR(1000),
        [receptorPrestadorId] NVARCHAR(1000),
        [status] NVARCHAR(1000) DEFAULT 'No_leido',
        [url] NVARCHAR(1000),
        [createdAt] DATETIME2 NOT NULL DEFAULT CURRENT_TIMESTAMP,
        [updatedAt] DATETIME2 NOT NULL,
    ...
    -- AddForeignKey
    ALTER TABLE [dbo].[Notificacion] ADD CONSTRAINT [Notificacion_receptorPrestadorId_fkey] FOREIGN KEY ([receptorPrestadorId]) REFERENCES [dbo].[Prestador]([id]) ON DELETE NO ACTION ON UPDATE CASCADE;
