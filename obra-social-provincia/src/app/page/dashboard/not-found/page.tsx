      ...
      <div className="not-found-container">
        ...
        <div className="message-box">
          ...
          <div className="buttons-con">
            ...
            <p>Lo siento, Probablemente aun no seleccionas un Usuario</p>
              <Link href="/page/select-user">
                <button className="link-button link-back-button">Seleciona Usuario</button>
              </Link>
              <Link href="/">
                <button className="link-button">Pagina de Inicio</button>
              </Link>
            </div>
          </div>
        </div>
